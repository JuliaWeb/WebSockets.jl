...
import logutils_ws.WebSocketLogger
...
@test min_enabled_level(WebSocketLogger(devnull, Logging.Debug)) == Logging.Debug
@test min_enabled_level(WebSocketLogger(devnull, Logging.Error)) == Logging.Error
...
logger = WebSocketLogger(io, Logging.Debug,
